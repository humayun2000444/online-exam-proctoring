                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="relative w-1/3">
                            ...
                            <input
                                ...
                                className="pl-10 pr-4 py-2 w-full border rounded-xl bg-gray-100 focus:outline-none focus:ring-2 focus:ring-green-400"
                            />
                        </div>
                    </div>
                        ...
                        <table className="min-w-full text-sm text-left text-gray-700">
                            ...
                            {filteredStudents.length === 0 ? (
                                ...
                                filteredStudents.map((student, index) => (
                                    <tr
                                        key={student.id}
                                        className={`${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'} cursor-pointer hover:bg-green-50 transition-colors duration-200`}
...
const StatCard = ({ icon, label, value }) => (
    <div className="bg-white p-6 rounded-2xl shadow-lg text-center hover:shadow-xl transition duration-300">
